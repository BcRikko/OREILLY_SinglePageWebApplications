...
spa.model = (function () {
    ...
    //     「spa-listchange」と「spa-updatechat」グローバルカスタムイベントのための
    //     パブリッシャを含むバックエンドとのチャットプロトコルを確立する
    //     現在のユーザが匿名の場合、join()は中断してfalseを返す
    //   * get_chatee() - ユーザがチャットをしている相手のpersonオブジェクトを返す
    //     チャット相手が居ない場合はnullを返す
